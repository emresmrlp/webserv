...
/*   Updated: 2026/03/22 18:47:55 by ysumeral         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define AUTOINDEX 1 // on -> 1, off -> 0;
# define ROOT "www"
# define INDEX "index.html"
# define ERROR_PAGE_FOUND 0

//example -> localhost:8080 path is / and configuration says / -> /index
//           i need this situation path = /index

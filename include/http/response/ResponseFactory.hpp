...
/*   Updated: 2026/06/13 09:33:30 by ysumeral         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace http
{
    ...
    class ResponseFactory
    {
        public:
            ...
            http::IResponse *createErrorResponse(const config::ConfigServer *config, http::Request *request, http::StatusCode statusCode);

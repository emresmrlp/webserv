...
/*   Updated: 2026/05/31 20:46:56 by ysumeral         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace http
{
    ...
    class ResponseFactory
    {
        public:
            ResponseFactory();
            ~ResponseFactory();
            http::IResponse *createStaticResponse(const config::ConfigServer *config, http::Request *request, std::size_t bodySize);
